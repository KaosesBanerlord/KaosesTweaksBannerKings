...
namespace KaosesTweaksBannerKings.Event
{
    ...
    class PlayerBattleEndEventListener
    {
        ...
        public PlayerBattleEndEventListener()
        {
            ...
            Factory.IM.Lm("Killing Bandits : PlayerBattleEndEventListener Called" + "");
        }

        public void IncreaseLocalRelationsAfterBanditFight(MapEvent m)
        {
            Factory.IM.Lm("Killing Bandits : IncreaseLocalRelationsAfterBanditFight Called" + "");
        ...
        private void IncreaseLocalRelations(MapEvent m)
        {
            ...
            if (Factory.Settings.SizeBonusEnabled)
            {
                ...
                {
                    Factory.IM.MessageDebug("Killing Bandits: SizeBonusEnabled: " + FinalRelationshipIncrease.ToString());
                }
            }
            int FinalRelationshipIncreaseInt = (int)Math.Floor(FinalRelationshipIncrease);
            if (Factory.Settings.KillingBanditsDebug)
            {
                Factory.IM.MessageDebug("Killing Bandits: IncreaseLocalRelations: " + "Base Change: " + Factory.Settings.RelationshipIncrease.ToString() + "Final Change: " + FinalRelationshipIncreaseInt.ToString());
            }
            ...
            if (Factory.Settings.KillingBanditsRelationReportEnabled)
                Factory.IM.MessageGreen("Final Relationship Increase: " + FinalRelationshipIncreaseInt.ToString());
        ...
        private void BanditGroupCounterUpdate()
        {
            ...
            if (Factory.Settings.KillingBanditsDebug)
            {
                Factory.IM.MessageDebug("Killing Bandits : BanditGroupCounterUpdate: " + BanditGroupCounter.ToString());
            }
        }
      ...
      Source=KaosesTweaks
      StackTrace:
       at KaosesTweaksBannerKings.Event.PlayerBattleEndEventListener.IsDefeatedBanditLike(MapEvent m) in U:\BannerLord\MyMods\KaosesTweaks\KaosesTweaks\Event\PlayerBattleEndEventListener.cs:line 137
