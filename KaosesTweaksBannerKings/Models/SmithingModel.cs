...
namespace KaosesTweaksBannerKings.Models
{
    ...
    public class SmithingModel : BKSmithingModel
    {
        ...
        public override int GetEnergyCostForSmithing(ItemObject item, Hero hero)
        {
            ...
            if (item.WeaponComponent is { PrimaryWeapon: { } })
            {
                ...
                num = weaponClass switch
                {
                    WeaponClass.TwoHandedAxe or WeaponClass.TwoHandedMace or WeaponClass.TwoHandedSword =>
                        (int)(num * 1.5f),
                    WeaponClass.OneHandedSword or WeaponClass.OneHandedAxe or WeaponClass.Mace => (int)(num * 1.2f),
                    _ => num
                };
            }
            return num;
