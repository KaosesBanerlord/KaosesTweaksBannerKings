...
namespace KaosesTweaksBannerKings.Settings
{
    ...
    public class Config : AttributeGlobalSettings<Config>
    {
        ...
        public string ModName => "Kaoses Tweaks BannerKings";
...
#pragma warning disable CS8620 // Argument cannot be used for parameter due to differences in the null ability of reference types.
        ...
        public override string DisplayName => new TextObject("{=KaosesTweaksBannerKingsDisplayName}" + ModName + " " + versionTextObj.ToString())!.ToString();
