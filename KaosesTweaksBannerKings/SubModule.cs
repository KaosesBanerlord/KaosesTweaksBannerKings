...
using KaosesTweaksBannerKings.Behaviors;
using KaosesTweaksBannerKings.Event;
using KaosesTweaksBannerKings.Objects;
using KaosesTweaksBannerKings.Settings;
using KaosesTweaksBannerKings.Tweaks;
using System;
...
{
    /// <summary>
    /// KaosesTweaksBannerKings Mod
    /// </summary>
    public class SubModule : MBSubModuleBase
    {
        public const bool UsesHarmony = true;
        public const string ModuleId = "KaosesTweaksBannerKings";
